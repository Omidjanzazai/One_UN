...
@section('content')
<form action="{{route('ngo.filter', session('sub-menu'))}}" class="my-2" id="fillter_form" method="get">
	<div class="row">
		<div class="col-lg-6">
			<label>Value</label>
...
<div class="card">
	<div class="card-header">
        ...
        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#add_modal"> <i class="icon icon-plus"></i>New NGO</button>
    </div>
    <div id="add_modal" tabindex="-1" role="dialog" class="modal fade">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
            <h4 class="modal-title"><i class="icon icon-plus"></i>NGO Details</h4>
            <button type="button" class="close" data-dismiss="modal">
                <span aria-hidden="true">×</span>
            </button>
            </div>
            <div class="modal-body">
                <form action="{{route('ngo.store', session('sub-menu'))}}" method="post">
                    @csrf
                    <input type="hidden" name="type" value="{{session('sub-menu') == 'Inernational NGOs' ? 1 : 2}}">
                    <div class="row">
                        <div class="col-lg-6">
                            <label>Name</label>
