...
@endphp
<form action="{{route('district.filter')}}" class="my-2" id="fillter_form" method="get">
	<div class="row">
		<div class="col-lg-3">
		...
		<div class="col-lg-3">
            ...
            <select class="form-control" name="province_id" id="province_id_fillter">
...
<div class="card">
	<div class="card-header">
        ...
        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#add_modal"> <i class="icon icon-plus"></i>New District</button>
    </div>
    <div id="add_modal" tabindex="-1" role="dialog" class="modal fade">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
            <h4 class="modal-title"><i class="icon icon-plus"></i>District Details</h4>
                ...
                <form action="{{route('district.store')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control" name="province_id" id="province_id_0" required>
                                <option value="">--Select Province--</option>
                            </select>
                        </div>
                        <div class="col-lg-12">
	...
	<div class="card-body">
		<div class="table-responsive" id="table-data">
            @include('configuration.district.pagination_data')
		</div>
	</div>
</div>
@endsection
