        ...
        <tr class="text-center">
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('ministry.delete')}}" id="delete_form{{$item->id}}">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                <h4 class="modal-title">Editing Ministry</h4>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">×</span>
                </button>
                </div>
                <div class="modal-body">
                <form action="{{route('ministry.update')}}" id="edit_form{{$item->id}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="sector" form="edit_form{{$item->id}}" class="form-control" oninvalid="InvalidMsg(this);" value="{{$item->sector}}" required>
                        </div>
                        <div class="col-lg-6">
                            <label>Country</label>
